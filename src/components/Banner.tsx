...
function App() {
  return (
    <>
      <div
        className="h-[calc(100vh-80px)] pt-20 flex justify-center items-center bg-cover bg-center"
      ...
      >
        <div className="flex flex-col items-center w-[450px] text-[#3F3F3F] text-center gap-5">
          ...
          <a className="w-fit bg-[#CFAD48] p-3 rounded-lg font-extrabold shadow-[0_8px_10px_rgba(0,0,0,0.25)]">
            Kontak Kami
          </a>
        </div>
      </div>
